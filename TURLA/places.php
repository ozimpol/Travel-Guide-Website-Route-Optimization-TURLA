...
<body>
  ...
  <div class="buttons">
    <button class="active" data-sort="sort-all">All Places</button>
    <button data-sort="Food">Food Places</button>
    <button data-sort="Historic">Historical Places</button>
    <button data-sort="Nature">Natural Beauties</button>
  </div>
